...
import JBSubject from '../../SVGs/JBSubject';
import JBCity from '../../SVGs/JBCity';
import JBLevel from '../../SVGs/JBLevel';
                    ...
                    <View
                        ...
                        <View>
                            <View
                                ...
                                <Text
                                    style={[styles.textType3, { color: Theme.white, fontSize: 14, textTransform: 'capitalize',fontFamily: 'Circular Std Bold',
                                        fontWeight: 500 }]}>
                                    {item?.mode}
                                </Text>
