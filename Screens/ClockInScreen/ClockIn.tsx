...
function ClockIn({navigation, route}: any) {
  ...
  return (
    <View style={{flex: 1, alignItems: 'center',backgroundColor:Theme.GhostWhite}}>
        ...
        <View
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 15 }}>
            ...
            <View>
              ...
              <Text style={[styles.textType3]}>{item?.studentName.length > 7 ? `${item?.studentName.slice(0, 7)}..` : item?.studentName}</Text>
            </View>
          </View>
